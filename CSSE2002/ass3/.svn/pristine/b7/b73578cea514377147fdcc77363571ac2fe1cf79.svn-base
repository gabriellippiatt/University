...
public class Network {
     ...
     *
     * <p>If the stop is already in the list, a DuplicateStopException should be
     * thrown.
     *
     * @param stop The stop to add to the network.
     *
     * @throws DuplicateStopException
     *                  If the given stop already exists in
     *                  the network.
     */
     ...
     *
     * @throws DuplicateStopException
     *      If any of the stops already exist in the network. If there are any
     *      duplicate stops, none of the stops should be added (i.e. either all
     *      of the stops are added, or none are).
     */
