 ...
 * passengers to in order to get them to that destination, as well as the
 * cost (in Manhattan distance) required to reach the destination when going
 * via that intermediate stop.
 */
public class RoutingEntry {
    // the new stop
    private Stop next;
    // the cost to the next stop
    private int cost;
