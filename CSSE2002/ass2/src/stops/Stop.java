...
public class Stop extends Object implements Writeable {
     ...
     *      1 - x- or y- coordinates that are not integer values.
     *      2 - Any extra delimiters (:) being encountered whilst parsing.
     *      3 - Any of the parts of the string being missing. This includes a
     *          missing stop name (as this is defined as invalid according to
    ...
    public static Stop decode(String stopString)
        ...
        String[] components = stopString.split(":");
        ...
        try {
            xCoordinate = Integer.parseInt(components[1].trim());
            yCoordinate = Integer.parseInt(components[2].trim());
        } catch(NumberFormatException e) {
            throw new TransportFormatException();
        }

            return new Stop(name, xCoordinate, yCoordinate);
    }
