...
class _SearchListExampleState extends State<SearchListExample> {
  ...
  void values() {
    _list = List();
    _list.add("Saint Lucia, 4067");
    _list.add("Toowong,4066");
    _list.add("Indooroopilly, 4068");
    _list.add("Milton, 4064");
    _list.add("Paddington, 4064");
    _list.add("Fortitude Valley, 4006");
