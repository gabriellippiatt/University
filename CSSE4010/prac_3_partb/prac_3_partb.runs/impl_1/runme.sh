...
HD_PWD='C:/Users/gabri/OneDrive/Desktop/Semester 2 2021/CSSE4010/prac_3_partb/prac_3_partb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two_digit_bcd_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two_digit_bcd_adder.tcl -notrace
