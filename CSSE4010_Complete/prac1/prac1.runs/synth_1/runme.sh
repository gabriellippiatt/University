...
HD_PWD='C:/Users/gabri/OneDrive/Desktop/Semester 2 2021/CSSE4010/prac1/prac1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and2or.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and2or.tcl
