...
HD_PWD='C:/Users/gabri/OneDrive/Desktop/Semester 2 2021/CSSE4010/prac1/prac1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and2or.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and2or.tcl -notrace
