...
HD_PWD='C:/Users/gabri/OneDrive/Desktop/Semester 2 2021/CSSE4010/prac_3_partb/prac_3_partb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two_digit_bcd_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two_digit_bcd_adder.tcl
