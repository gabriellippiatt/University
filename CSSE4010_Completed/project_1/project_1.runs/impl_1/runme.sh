...
HD_PWD='C:/Users/gabri/OneDrive/Desktop/Semester 2 2021/CSSE4010/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log locktop_async.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source locktop_async.tcl -notrace
